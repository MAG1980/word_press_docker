        ...
        <div class="glide__track" data-glide-el="track">
            <ul class="glide__slides">
                ...
                $my_posts = get_posts(array(
                    'numberposts' => -1, //Количество выводимых постов (-1 - бесконечность)
                ...
                foreach ($my_posts as $post) {
                    ...
                    ?>
                    <li style="background-image: url('<?= bloginfo('template_url'); ?>/assets/img/bg_1.jpg')"
                        class="glide__slide">
                        <div class="container">
                            <div class="row">
                ...
                ?>
                <!--                <li style="background-image: url('<?php /*= bloginfo('template_url'); */ ?>/assets/img/bg_1.jpg')"
                    class="glide__slide">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 offset-1">
                ...
                <li style="background-image: url('<?php /*= bloginfo('template_url'); */ ?>/assets/img/bg_2.jpg')"
                    class="glide__slide">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 offset-1">
                ...
                <li style="background-image: url('<?php /*= bloginfo('template_url'); */ ?>/assets/img/bg_3.jpg')"
                    class="glide__slide">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 offset-1">
    ...
    <div class="toys" id="toys">
        <div class="container">
            ...
            <div class="toys__wrapper">
                ...
                <div class="toys__item"
                     style="background-image: url(<?= bloginfo('template_url'); ?>/assets/img/toy_2.jpg)">
                    <div class="toys__item-info">
                ...
                <div class="toys__item"
                     style="background-image: url(<?= bloginfo('template_url'); ?>/assets/img/toy_3.jpg)">
                    <div class="toys__item-info">
                ...
                <div class="toys__item"
                     style="background-image: url(<?= bloginfo('template_url'); ?>/assets/img/toy_4.jpg)">
                    <div class="toys__item-info">
                ...
                <div class="toys__item"
                     style="background-image: url(<?= bloginfo('template_url'); ?>/assets/img/toy_5.jpg)">
                    <div class="toys__item-info">
                ...
                <div class="toys__item"
                     style="background-image: url(<?= bloginfo('template_url'); ?>/assets/img/toy_6.jpg)">
                    <div class="toys__item-info">
            ...
            <div class="toys__wrapper">
                ...
                <div class="toys__item"
                     style="background-image: url(<?= bloginfo('template_url'); ?>/assets/img/toy_7.jpg)">
                    <div class="toys__item-info">
                ...
                <div class="toys__item"
                     style="background-image: url(<?= bloginfo('template_url'); ?>/assets/img/toy_8.jpg)">
                    <div class="toys__item-info">
    ...
    <div class="aboutus" id="aboutus">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="aboutus__img" src="<?= bloginfo('template_url'); ?>/assets/img/about_1.jpg"
                         alt="мир детства">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <img class="aboutus__img" src="<?= bloginfo('template_url'); ?>/assets/img/about_2.jpg"
                         alt="мир детства">
                </div>
                <div class="col-lg-6">
                    <div class="subtitle">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="aboutus__img" src="<?= bloginfo('template_url'); ?>/assets/img/about_3.jpg"
                         alt="мир детства">
                </div>
            </div>
        </div>
